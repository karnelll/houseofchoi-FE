...
const MypageCard: React.FC<MypageCardProps> = ({ name, userCode }) => {
  return (
    <div className="w-full max-w-[330px] min-h-[233px] rounded-2xl bg-white shadow-header flex flex-col items-center justify-center py-8 px-6 gap-6 text-center font-pretendard">
